...
loc_2673:
		add	di, di
		or	al, al
		jnz	short locret_26C6
		mov	al, 2
		mul	[ds:_smartItems.field_B+bp]
		add	di, ax
		mov	ax, [es:di]
		mov	[word  cs:renderFn],	ax
		mov	di, [ds:_smartItems.anonymous_15+bp]
		mov	bx, [ds:_smartItems.anonymous_13+bp]
...
loc_2738:
		...
		mov	ax, [es:di]
		mov	[word  cs:renderFn],	ax
		mov	si, [ds:_smartItems.anonymous_15+bp]
		mov	bx, [ds:_smartItems.anonymous_13+bp]
