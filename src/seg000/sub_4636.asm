...
%push local
		...
		sub	bx, [word_1D12C]
		cmp	bx, 1C0h
		jnb	short near  sub_4633
		mov	bx, dx
		sub	bx, [word_1D12E]
		cmp	bx, 120h
		jnb	short near  sub_4633
		test	[word  ds:_smartItems.field_3A+bp], 1
		jnz	short loc_46BE
		test	[ds:_smartItems.anonymous_17+bp], 0Fh
		jz	short loc_4690
		xor	bx, bx
		mov	cx, 400h
		...
		js	short loc_4681
		or	[word  ds:_smartItems.field_3A+bp], 1
loc_4681:
...
loc_46B2:
		...
		adc	ax, bx
loc_46BE:
		test	[word  ds:_smartItems.field_3A+bp], 2
		jz	short loc_46CD
		add	dx, 3
		jmp	short loc_4703
		db 90h
loc_46CD:
		...
		cmp	cx, 3
		jl	short loc_46F2
		or	[word  ds:_smartItems.field_3A+bp], 2
		add	dx, 3
		jmp	short loc_4703
		align 2
loc_46F2:
...
loc_4703:
		...
		mov	[ds:_smartItems.anonymous_15+bp], dx
		jmp	near  sub_2648
%pop
