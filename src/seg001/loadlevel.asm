...
loc_6763:
		...
		push	[word  _fruitImagePtr]
		mov	bx, [_levelData]
		push	[bx+LevelData.index_palette]
		nop
		push	cs
		call	near  loadfromdat
		add	sp, 6
...
loc_696F:
		...
		mov	[es:bx+LevelContents_c.field_8], 0
		add	[word  bp+var_C], size LevelContents_c
loc_6984:
		les	bx, [bp+var_C]
		...
		mov	[_levelContents2], LevelContents_c.field_8
		pop	di
		pop	si
		leave
		retf
